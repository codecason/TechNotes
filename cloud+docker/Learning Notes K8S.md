...
知识点: 1.Kubernetes内置的的账号管理及特点 2.Kubernetes采用的权限控制模型及模型特点 3.Kubernetes创建新的ServiceAccount
...
知识点: 1.学习Kubernetes中Pod的作用和组成 2.学习如何使用GoSDK来CRUD Pod对象

知识点: 1.学习Kubernetes中Service的作用和组成 2.学习如何使用GoSDK来CRUDService对象 
